      ...
      <section>
        <Heading classNames="flex items-center justify-between">
          ...
          <span className="flex gap-3 items-center">
            <span className="text-xl px-3 py-2 bg-slate-300 rounded-md">{filter}</span>
            <Link href={URLS.todos} className="text-xl px-3 py-2 bg-emerald-300 rounded-md">view all &rsaquo;</Link>
          </span>
        </Heading>
